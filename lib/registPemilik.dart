...
class RegistPemilik extends StatelessWidget {
  final TextEditingController emailController = TextEditingController();
  final TextEditingController noHPController = TextEditingController();
  final TextEditingController alamatController = TextEditingController();
  final TextEditingController passwordController = TextEditingController();

  RegistPemilik({Key? key}) : super(key: key);

  Future<void> registerOwner(BuildContext context, String email, String noHP,
    ...
    final response = await http.post(
      Uri.parse('http://10.0.2.2:3308/register_pemilik'),
    ...
    if (response.statusCode == 200) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => LoginPemilik()),
      );
    } else {
